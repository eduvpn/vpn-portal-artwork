...
return [
    ...
    'On your "Account" page you can block access to the VPN in case you lose a device.' => 'Sollten Sie ein Gerät nicht mehr besitzen, können Sie auf der Benutzerkonto-Seite Gerätezugriffe sperren.',
    'To use eduVPN, download the app for your device below!' => 'Um eduVPN zu nutzen laden Sie sich die Anwendung für Ihr Gerät herunter und installieren Sie diese.',
    'Welcome to eduVPN!' => 'Willkommen bei eduVPN!',
    //'Windows' => '',
    //'iOS' => '',
    //'macOS' => '',
    // [DELETED] 'Download' => 'Herunterladen',
];
